    ...
    >
      <div className="flex flex-no-wrap">
        <div className=" fixed w-64 h-screen top-16 shadow bg-gray-100 hidden lg:block">
          <div className="h-16 w-full flex items-center px-8">
            <Link to={"/"}>
              <img width={40} src="https://assets.change.org/photos/9/zh/sb/VqzhSBEEHpTMbDK-800x800-noPad.jpg?1560371548" alt="logo" className="mt-6" />
              <p className="text-center text-base font-extrabold">ChangeEveryWhere</p>
            </Link>
          </div>
          <ul aria-orientation="vertical" className=" py-6">
            ...
            <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
              <div className="flex items-center">
                ...
                <Link to={"contacts"}>
                  <span className="ml-2">List of Contacts</span>
                </Link>
              </div>
            </li>
          </ul>
      ...
      >
        ...
        <footer className="text-center sticky top-full footer p-4 justify-center text-base-content">
          <p>
            Copyright © 2022 - All right reserved by ArchiMEDOnline
          </p>
        </footer>
        {/*Footer*/}
      </div>
