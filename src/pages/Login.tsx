    ...
    <>
      <div className="flex justify-center items-center bg-indigo-50 h-screen w-full">
        <div className="flex justify-center items-center ">
          <div className="xl:px-20 w-full md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
            ...
            <div className="xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6">
              ...
              <div className="flex items-start mt-8">
                ...
                <p className="sm:text-2xl text-xl leading-7 text-gray-600 pl-2.5">
                  As part of an engineering internship, summer 2022, we conceived the idea of developing a modern medical platform. The goal will be the creation of an "enterprise application". <br /> A powerful application on a large scale.
                </p>
              </div>
            </div>
          </div>
