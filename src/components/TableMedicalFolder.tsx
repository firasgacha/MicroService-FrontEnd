                    ...
                    <div className="bg-white rounded-md shadow fixed overflow-y-auto sm:h-auto w-10/12 md:w-8/12 lg:w-1/2 2xl:w-2/5">
                        ...
                        <div className="px-4 md:px-10 pt-6 md:pt-12 md:pb-4 pb-7">
                            ...
                            <div className="flex items-center justify-between mt-9">
                                <button onClick={() => setshowModal(!showModal)} className="px-6 py-3 bg-gray-400 hover:bg-gray-500 shadow rounded text-sm text-white">
                                    Cancel
                                </button>
                                <button className="px-6 py-3 bg-indigo-700 hover:bg-opacity-80 shadow rounded text-sm text-white">Confirm</button>
                            </div>
                        </div>
                    </div>
                </div>
